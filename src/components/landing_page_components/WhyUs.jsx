...
const WhyUs = () => {
    return (
        <section id="whyus" className="w-full md:h-[60vh] relative">
            ...
            <div className="relative z-10 w-full py-16 md:py-20">
                <div className="max-w-[1440px] mx-auto px-4">
                    ...
                    <div className="md:hidden flex flex-col items-center text-center">
                        <h2 className="font-glitten text-[24px] font-400 text-[#2D3542] mb-6">
                            Why Infinity
                        </h2>
                        <p className="w-[353px] text-[14px] font-400 leading-[20px] text-[#2D3542] mb-6">
