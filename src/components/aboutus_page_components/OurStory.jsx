        ...
        <section className="w-full py-[50px] md:py-[80px] px-4 bg-white">
            <div className="max-w-[1240px] mx-auto flex flex-col md:flex-row items-center gap-[40px] md:gap-[80px]">
                ...
                <div className="w-full md:w-1/2 order-1 md:order-1">
                    <h2 className="font-glitten text-[24px] md:text-[40px] text-[#0E1727] font-normal mb-6 md:mb-8">
                        Our Story
                    </h2>
                    <p className="text-[14px] md:text-[18px] text-[#2D3542] font-normal leading-[1.6] mb-6">
                    ...
                    <p className="text-[14px] md:text-[18px] text-[#2D3542] font-normal leading-[1.6]">
